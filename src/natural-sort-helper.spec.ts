...
describe('NaturalSortHelper', () => {
  describe('getNaturalValueFn', () => {
    ...
    it('should return function to get value from specified nested field', () => {
      const test = NaturalSortHelper.getNaturalValueFn('a', 'b');
      const val = 'test';
      const obj = { a: { b: val } };
      const result = test(obj);
      expect(result).to.equal(val);
  ...
  describe('getNaturalValue', () => {
    it('should return empty string when null', () => {
      const result = NaturalSortHelper.getNaturalValue(null);
    ...
    it('should surround with padded zeroes for length of digit strings ', () => {
      ...
      const result = NaturalSortHelper.getNaturalValue(val);
  ...
  describe('naturalSort', () => {
    it('should return 1 when a is greater than b', () => {
      const a = '1.2';
      const b = '1.12';
      const result = NaturalSortHelper.naturalSort(a, b);
    ...
    it('should return -1 when a is greater than b and isDesc', () => {
      const a = '1.2';
      const b = '1.12';
      const result = NaturalSortHelper.naturalSort(a, b, true);
      expect(result).to.equal(-1);
    });
